...
def build_mosaic(args, layout_map, catalog):
    ...
    mosaic_w = args.grid_cols * args.thumb_size + 2 * args.border_padding
    mosaic_h = grid_rows * args.thumb_size + 2 * args.border_padding
    ...
    draw_title(draw, catalog.title(), title_font, mosaic_w, args.thumb_size, args.border_padding)
    ...
    if images_count < catalog_count:
        ...
        draw_progress(draw, progress_text, font, args.grid_cols - 1, grid_rows - 1, args.border_padding, args.thumb_size)
